...
Состояние работы на диске (переживает суммаризацию контекста). Источник истины — `docs/spec.md`.
Онбординг — `AGENTS.md`; архитектура/инварианты — `docs/architecture.md`.
...
### 🔄 Редизайн «Memento Mori» (по `docs/archive/redesign-plan.md`, опора — `docs/research/report.md`)
...
### 🔧 Фиксы code-review (`docs/archive/code-review-2026-06-28.md`)
...
### 🧩 Рефакторинг модульности (по `docs/archive/modularity-review-2026-07-01`, 2026-07-09)
